            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        ...
                        <div class="card-body">
                            <form method="post" action="../admin/artikel/aksi_simpan.php" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="hidden" class="form-control" name="id_user_artikel" id="id_user_artikel" value="<?php echo"$_SESSION[akun_id]";?>">
                                                   <input type="text" name="judul_artikel" id="judul_artikel" class="form-control" placeholder="Seminar Nasional Amikom Ke 5">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                  ...
                                                  <div class="custom-file mb-3">
                                                      ...
                                                      <label class="custom-file-label form-control" for="customFile">Pilih Gambar Artikel</label>
                                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="date" name="batas_artikel" id="batas_artikel" class="form-control" placeholder="dd/mm/yyyy">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi_artikel" id="deskripsi_artikel" class="form-control" rows="10"></textarea>
