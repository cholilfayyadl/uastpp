		        ...
		        <div class="card regform wow bounce animated" data-wow-delay="0.05s">
		            <div class="card-body regform">
		               <div class="myform form ">
                        ...
                        <form method=POST action="action_signup.php" name="registration">
                           <div class="form-group">
                              
                              <input type="text"  name="nama_depan" class="form-control" id="nama_depan" aria-describedby="emailHelp" placeholder="Nama Depan Anda" required>
                           </div>
                           <div class="form-group">
                              
                              <input type="text"  name="nama_belakang" class="form-control" id="nama_belakang" aria-describedby="emailHelp" placeholder="Nama Belakang" required>
                           </div>

                            <div class="form-group">
                              
                              <input type="text"  name="no_hp" class="form-control" id="no_hp" aria-describedby="emailHelp" placeholder="Nomor Telepon / WhatsApp" required>
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <input type="password" name="sandi" id="sandi"  class="form-control" aria-describedby="emailHelp" placeholder="Kata Sandi Anda" required>
                           </div>
