...
if(isset($_SESSION['akun_id'])){ // Jika session username ada berarti dia sudah login
  header("location: adminweb.php?module=home"); // Kita Redirect ke halaman welcome.php
}
						...
						<div class="myform form ">
							...
							<form method=POST action="action_signin.php" name="registration">
								...
								<div class="form-group">
									...
									<input type="password" name="sandi" id="password"  class="form-control" aria-describedby="emailHelp" placeholder="Kata Sandi Anda" required>
								</div>
