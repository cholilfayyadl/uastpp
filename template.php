...
<head>
    ...
    <link href="admin/themify-icons.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="asset/images/img1.jpg"
                                                            alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="asset/images/img2.jpg"
                                                            alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="asset/images/img3.jpg"
                                                            alt="Third slide"></div>
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="asset/images/1.jpg" alt="user"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="asset/images/2.jpg" alt="user"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="asset/images/3.jpg" alt="user"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="asset/images/4.jpg" alt="user"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="asset/images/1.jpg" alt="user"
                                    class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="asset/images/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div class="user-profile" style="background: url(asset/images/user-info.jpg) no-repeat;">
                    <!-- User profile image -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card blog-widget">
                            <div class="card-body">
                                <div class="blog-image"><img src="asset/images/img1.jpg" alt="img" class="img-responsive" /></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <img class="" src="asset/images/weatherbg.jpg" alt="Card image cap">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <!-- Column -->
                        <div class="card">
                            <img class="card-img-top" src="asset/images/profile-bg.jpg" alt="Card image cap">
                            <div class="card-body little-profile text-center">
                                <div class="pro-img"><img src="asset/images/4.jpg" alt="user" /></div>
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline">
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="asset/images/1.jpg" alt="user"
                                                ...
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="asset/images/img1.jpg"
                                                                    alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="asset/images/img2.jpg"
                                                                    alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="asset/images/img3.jpg"
                                                                    alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="asset/images/4.jpg"
                                                                    alt="user" class="img-responsive radius"></div>
                                                        </div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="asset/images/2.jpg" alt="user"
                                                        class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
                                                        <div class="m-t-20 row">
                                                            <div class="col-md-3 col-xs-12"><img src="asset/images/img1.jpg"
                                                                    alt="user" class="img-responsive radius"></div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="asset/images/3.jpg" alt="user"
                                                        class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="asset/images/4.jpg" alt="user"
                                                        class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
